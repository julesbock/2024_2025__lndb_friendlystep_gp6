...
#             mbox.showwarning("Erreur", nothing_enter_text_error, icon = "error")
#         elif "@" not in email:
#             mbox.showwarning("Erreur", no_symbol_text_error, icon = "error")
#         else:
#             mbox.showinfo("Succès", f"Connexion réussie pour {email} (simulée).", icon = "info")

# # Lancement de l'application
# def connexion():
#     root = tk.Tk()
#     app = OurLoginApp(root)
#     root.mainloop()